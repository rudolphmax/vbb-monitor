...
| `VBBMON_API_PARAMS`         | (optional )Additional parameters passed to the API. Provided as a JSON string. | '{ "operators": "BVG" }'          |
...
| `VBBMON_REFRESH_INTERVAL`   | (optional) The data refresh interval in ms                                     | 25000                             |
| `VBBMON_NUM_LINES`          | (optional) The number of lines / departures fetched                            | 10                                |
